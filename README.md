...
3. Choose a name (e.g., "my-ensemble-playback")
   - You'll see an option to "Include all branches" - you can leave this unchecked (default is fine)
4. **Set visibility:**
...
- GitHub Actions workflow must complete successfully (check the **Actions** tab in your repo)
